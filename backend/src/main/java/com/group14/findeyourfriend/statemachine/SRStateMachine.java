...
public class SRStateMachine extends StateMachineProcess {
	...
	public SRStateMachine() {
		...
		_transitions.put(new StateTransition(ProcessState.INTERPRET_STATE, Command.FriendNotFound),
				ProcessState.SLEEP_STATE);
		_transitions.put(new StateTransition(ProcessState.INTERPRET_STATE, Command.FriendFound),
		...
		_transitions.put(new StateTransition(ProcessState.S_LOOKUP_STATE, Command.FriendNotFound),
				ProcessState.REQUEST_STATE);
		_transitions.put(new StateTransition(ProcessState.REQUEST_STATE, Command.TimerIP),
				ProcessState.INTERPRET_STATE);
		...
		_transitions.put(new StateTransition(ProcessState.R_LOOKUP_STATE, Command.SendResponse),
				ProcessState.RESPONSE_STATE);
		_transitions.put(new StateTransition(ProcessState.R_LOOKUP_STATE, Command.NoResponse),
				ProcessState.UPDATE_STATE);
		...
		_transitions.put(new StateTransition(ProcessState.UPDATE_STATE, Command.StartSearch),
				ProcessState.S_LOOKUP_STATE);
		_transitions.put(new StateTransition(ProcessState.LISTEN_STATE, Command.StartSearch),
				ProcessState.S_LOOKUP_STATE);
		_transitions.put(new StateTransition(ProcessState.R_LOOKUP_STATE, Command.StartSearch),
				ProcessState.S_LOOKUP_STATE);
		_transitions.put(new StateTransition(ProcessState.RESPONSE_STATE, Command.StartSearch),
				ProcessState.S_LOOKUP_STATE);
		_transitions.put(new StateTransition(ProcessState.REQUEST_STATE, Command.StartSearch),
				ProcessState.S_LOOKUP_STATE);
		_transitions.put(new StateTransition(ProcessState.INTERPRET_STATE, Command.StartSearch),
				ProcessState.S_LOOKUP_STATE);
		...
		_transitions.put(new StateTransition(ProcessState.RESPONSE_STATE, Command.GoToEvent), ProcessState.LED_STATE);
		_transitions.put(new StateTransition(ProcessState.LISTEN_STATE, Command.GoToEvent), ProcessState.LED_STATE);
		_transitions.put(new StateTransition(ProcessState.INTERPRET_STATE, Command.GoToEvent), ProcessState.LED_STATE);
	}
